   ...
   <div class="editEventBody">
       ...
       <form class="editEventForm" action="" method="">
         ...
         <div class="inputsCont">
            ...
            <input type="text" name="" id="eventLocation" placeholder="" value="<?php echo $getEvtData['location'];?>">
         ...
         <div class="inputsCont dateTime" id="space">
            ...
            <input type="text" name="" id="eventStart" placeholder="" value="<?php echo $getEvtData['start_date'];?>">
            <input type="text" name="" id="eventTimeStart" placeholder="" value="<?php echo $getEvtData['start_time'];?>">
         ...
         <div class="inputsCont dateTime">
            ...
            <input type="text" name="" id="eventTimeEnd" placeholder="End time" value="<?php echo $getEvtData['end_time'];?>">
