<div class="allMenus">
  ...
  <div id="headContainer">
    ...
    <div id="menuItems">
          ...
          <a href="index.php?page=jaarOverzicht&id=<?php echo $_SESSION['id'];?>" class="primairyMenu">JAAR OVERZICHT</a>
  ...
  <div class="mobileMenu">
    ...
    <div class="menuFront">
      ...
      <div class="mobileMenuItems">
        ...
        <a href="index.php?page=jaarOverzicht&id=<?php echo $_SESSION['id'];?>" id="mobileCalenda"><p>Agenda</p></a>
